...
function StatistikaKlijenataSadrzaj() {
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center py-40 text-[--color-primary]">
        <Loader2 className="animate-spin mb-4" size={50} />
        <p className="font-bold italic uppercase tracking-widest">Generisanje izveštaja...</p>
      </div>
    );
  }
        ...
        <div className="max-w-6xl mx-auto p-4 md:p-10 flex flex-col items-center">
          <Suspense fallback={
            <div className="flex flex-col items-center justify-center py-40">
              <Loader2 className="animate-spin text-[--color-primary]" size={60} />
              <p className="mt-4 text-[--color-primary] font-bold italic">Učitavanje analitike...</p>
            </div>
          }>
