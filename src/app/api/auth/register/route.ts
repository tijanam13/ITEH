 ...
 *     description: Kreira novi korisnički nalog. JAVNA RUTA. Podrazumevana uloga je "KLIJENT".
 *     tags: [Auth]
 *     requestBody:
 *       required: true
 *       content:
 ...
 *       400:
 *         description: Loš zahtev (email postoji, prekratka lozinka ili nepotpuni podaci).
 *       500:
